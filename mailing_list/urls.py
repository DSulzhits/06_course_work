...
urlpatterns = [
    path('', cache_page(60)(IndexView.as_view()), name='homepage'),
    ...
    path('mailing_list_message/<int:pk>/', cache_page(60)(MailingListMessageDetailView.as_view()), name='message_detail'),
    path('mailing_list_message/create/', never_cache(MailingListMessageCreateView.as_view()), name='message_create'),
    path('mailing_list_message/update/<int:pk>/', never_cache(MailingListMessageUpdateView.as_view()), name='message_update'),
    path('mailing_list_message/delete/<int:pk>/', never_cache(MailingListMessageDeleteView.as_view()), name='message_delete'),
